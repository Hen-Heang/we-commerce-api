...
public class PurchaseController {
    ...
    public PurchaseController(PurchaseService purchaseService, ReceiptService receiptService, ProductService productService) {
   ...
   @GetMapping("receipt/{id}")
    ...
    public ResponseEntity<?> UpdateStatus(@PathVariable("productId") Long productId){
